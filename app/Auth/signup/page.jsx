        ...
        <div className="w-screen h-screen bg-zinc-800 flex flex-col">
            <div className="m-auto flex  h-[262.5px] rounded-lg border-[2px] border-zinc-700 w-[400px] mb-[5px] ">
                <form className="flex flex-col w-full h-full bg-zinc-700">
                    ...
                    <input type="text" placeholder="Name" className="w-[100px] w-[90%] h-[50px] flex m-auto align-middle items-center rounded-lg justify-center text-center " ref={pname} />
                    ...
                    {
                        !isLoading && (<input type="submit" className="rounded-lg w-[100px] h-[50px] w-[90%] bg-red-500 flex m-auto align-middle hover:bg-red-600 hover:border-[2px] hover:border-red-800 cursor-pointer" onClick={(event) => { handleLogin(event) }} />)
                    }
                </form>
            </div>
